"""Reviewed public-rank-1 policy with certified exact-score tie randomization.
Source: aristophanivan/improved-probabilistic-agent.
Forward search is disabled because it lost the local certification gate."""
...
class AdvancedPolicy:
    ...
    def choose(self) -> list[int]:
        ...
        ranked = [i for i, _ in sorted(enumerate(scores), key=lambda item: (item[1], random.random()), reverse=True)]
